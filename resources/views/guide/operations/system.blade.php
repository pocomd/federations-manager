...
@section('title', 'System Administration — User Guide')
...
<div class="container-fluid py-4 px-4" style="max-width:1100px;">
    ...
    <div class="d-flex align-items-center justify-content-between mb-4 gap-3 flex-wrap">
        <div class="d-flex align-items-center gap-2">
            ...
            <i class="bi bi-chevron-right text-muted" style="font-size:.7rem;"></i>
            <span class="small fw-semibold">System Administration</span>
        </div>
    ...
    <div class="d-flex gap-0 border rounded" style="min-height:640px;"
        ...
        <div class="flex-shrink-0 border-end" style="width:230px;overflow-y:auto;">
            ...
            @php
            $ops = [
                1 => 'Import from Jagger',
                2 => 'Run a scheduled job immediately',
                3 => 'Configure scheduler timings',
                4 => 'Set system preferences',
                5 => 'Manage compliance rules',
                6 => 'Configure a webhook endpoint',
            ];
            @endphp
        ...
        <div class="flex-grow-1 p-4 overflow-auto">
            @include('guide.operations.partials.system')
        </div>{{-- /detail --}}
    </div>{{-- /two-column --}}
