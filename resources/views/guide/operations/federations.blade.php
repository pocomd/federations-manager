...
@section('title', 'Federation Operations — User Guide')
...
<div class="container-fluid py-4 px-4" style="max-width:1100px;">
    ...
    <div class="d-flex align-items-center justify-content-between mb-4 gap-3 flex-wrap">
        <div class="d-flex align-items-center gap-2">
            ...
            <i class="bi bi-chevron-right text-muted" style="font-size:.7rem;"></i>
            <span class="small fw-semibold">Federation Operations</span>
        </div>
    ...
    <div class="d-flex gap-0 border rounded" style="min-height:640px;"
        ...
        <div class="flex-shrink-0 border-end" style="width:230px;overflow-y:auto;">
            ...
            $ops = [
                ...
                2  => 'Add an entity',
                3  => 'Approve entity membership',
                4  => 'Reject entity membership',
                5  => 'Remove an entity',
                6  => 'Assign a federation manager',
                7  => 'Remove a federation manager',
                8  => 'Generate and publish metadata',
                9  => 'Upload signing keys',
                10 => 'Add a registration policy',
                11 => 'Configure an external validator',
                12 => 'Send email to members',
                13 => 'Export member contact list',
                14 => 'Deactivate / Reactivate',
                15 => 'Delete a federation',
            ];
            @endphp
        ...
        <div class="flex-grow-1 p-4 overflow-auto">
            @include('guide.operations.partials.federations')
        </div>{{-- /detail --}}
    </div>{{-- /two-column --}}
